...
import 'package:tripease/Application/driver/profileview_d.dart';

import '../rider/payment.dart';

class SettingsScreenDriver extends StatelessWidget {
  const SettingsScreenDriver({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _buildListTile('Total Earned', EvaIcons.award, context),
      ...
      onTap: () {
        if (title == 'View Profile') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ViewProfileScreenDriver(),
            ),
          );
