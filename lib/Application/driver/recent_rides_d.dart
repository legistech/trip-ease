...
class RecentRidesDriver extends StatelessWidget {
  const RecentRidesDriver({Key? key}) : super(key: key);
            ...
            Expanded(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage(ride.riderImage),
                ),
                title: Text(
                  ride.riderName,
